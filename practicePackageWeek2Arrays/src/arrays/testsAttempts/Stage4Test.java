...
public class Stage4Test {
	...
	void testGetLongestConsecutiveLength() {
		assertEquals(0, Stage4.getLongestConsecutiveLength(null));
        assertEquals(0, Stage4.getLongestConsecutiveLength(empty));
